...
image = Image.open("C:\\Users\\jolan\\Pictures\\gamejam\\colline9.png")
result = []
...
for ligne in range(36):
    ...
    for colonne in range(64):
        match image.getpixel((colonne,ligne))[:-1]:
            ...
            case (200, 191, 231):   result[ligne].append("e")   # Lavande : ennemi
            case (34, 177, 76):     result[ligne].append("d")   # Vert : décoration
            case (255, 127, 39):    result[ligne].append("P")   # Orange : PNJs
            case (181, 230, 29):    result[ligne].append("l")   # Vert clair : levier
